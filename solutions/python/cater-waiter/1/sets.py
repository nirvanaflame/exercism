...
def check_drinks(drink_name: str, drink_ingredients: set):
    ...
    """
    prefix = 'Cocktail' if len(ALCOHOLS.intersection(drink_ingredients)) > 0 else 'Mocktail'
    return drink_name + ' ' + prefix


def categorize_dish(dish_name: str, dish_ingredients: set):
